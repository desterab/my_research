...
\color{red}
\section{Experimet 4}
The previous experiments have established that incidental encoding reduces, and possibly totally eliminates, the TCE. This final experiment attempts to determine two things. First, does a residual contiguity effect remain, which although small, can be detected with sufficient statistical power? Second, can participants produce a TCE if you ask them 

is the TCE reduced because the temporal information is never encoded or because 
incidental encoding prevents temporal information from being encoded or simply because incidental encoding discuorages participants do not adopt a strategy of using it.

cite neath work here
