...
These findings suggests that the failure to find a significant TCE in Experiments 1 and 2 may have been due to a lack of statistical power. To be clear, their is no doubt that incidental encoding can reduce the TCE to \emph{near} zero, which is a very important finding. But, as discussed in detail below, it is also theoretically important that a small residual TCE remains.
