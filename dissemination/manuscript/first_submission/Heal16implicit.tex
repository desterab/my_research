...
\authornote{M. K. Healey is the sole author of this article and is responsible for its content. %I thank Mitchell Uitvlugt and SOME OTHER PEOPLE for helpful discussions. 
...
%This presentation rate was deliberately chosen to be slightly faster than the 5 seconds per word used by \citet{NairEtal16} to reduce the amount of ``free time'' subjects have between making the judgment and the presentation of the next word. 
...
\begin{figure*}
\fitfigure{/Users/khealey/Library/Mobile Documents/com~apple~CloudDocs/lab/code/experiments/Heal16implicit/static/analyses/shoebox.pdf}
...
\begin{figure*}%[hp]
\fitfigure{/Users/khealey/Library/Mobile Documents/com~apple~CloudDocs/lab/code/experiments/Heal16implicit/static/analyses/FrontDoor.pdf}
...
\begin{figure*}%[hp]
\fitfigure{/Users/khealey/Library/Mobile Documents/com~apple~CloudDocs/lab/code/experiments/Heal16implicit/static/analyses/E3.pdf}
...
% These results confirm that the type of processing subjects choose to engage during encoding powerfully influences how they recall the information and can eliminate the TCE \citep{Hint16,NairEtal16}. But.... positive spin?? 
