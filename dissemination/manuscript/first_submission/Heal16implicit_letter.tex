...
I ask that the attached manuscript, ``Temporal Contiguity in Incidentally Encoded Memories'', be considered for publication as a Research Report in Psychological Science. In the manuscript I present the results of three experiments that test competing theories of the temporal contiguity effect. The temporal contiguity effect is the finding that recalling one memory tends to trigger retreival of other memories that were encoded near in time to the first. Some theories suggest that this effect is an artifact of labratory tasks and should dissapare under incidental encoding. Other thories suggest that the effect tells us someting fundemental about memory and should be observed under many encoding conditions. The results show that the effect can indeed be observed under incidental encoding, suggesting that the first class of theories are wrong. But they also point to some important limitations in the second class of theories. Thus, the results make two imporant theoritical contributions.
 ...
 All data analyzed in the report is freely available to yourself and the reviewers at , and will be made publically available if the manuscript is accepted for publication.
